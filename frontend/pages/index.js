    ...
    <div className="fixed inset-0 w-full h-full bg-gradient-to-br from-white via-sky-50 to-cyan-25 overflow-auto">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen">
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          {features.length > 0 ? (
            <>
              {/* Para admin y docentes: separar las últimas 2 tarjetas en una fila especial */}
              {userRole === 1 || userRole === 2 ? (
                <>
                  {/* Tarjetas regulares (primeras 3 para admin, sin Incidentes e Informes para docentes) */}
                  ...
                  {/* Fila especial para las últimas 2 tarjetas */}
                  {((userRole === 2 && features.some(f => f.title === "Incidentes" || f.title === "Informes")) || 
                    (userRole === 1 && features.length > 3)) && (
