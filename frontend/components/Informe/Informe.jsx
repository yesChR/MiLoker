                ...
                <div className="bg-white shadow-lg rounded-2xl p-6 flex flex-col justify-between border-1 border-gray-100">
                    <div>
                        ...
                        <p className="text-gray-600  text-justify">
                            Esta opción permite generar un informe detallado y de forma gráfica la información sobre el total de casilleros donde se reflejarán aquellos qué esten disponibles, asignados o dañados. Ideal para obtener una visión general rápida y organizada.
                        </p>
                    </div>
                    <div className="mt-4">
                        <Button className="w-full bg-cabecera text-md font-semibold shadow-lg text-azulOscuro">Generar informe</Button>
                    </div>
                </div>
