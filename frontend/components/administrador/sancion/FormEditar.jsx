    ...
    return (
        <Form autoComplete="off">
            ...
            <div className="relative w-full mt-4">
                <textarea
                    placeholder=" "
                    className={`border-2 rounded-2xl p-2 pt-7 w-full h-32 resize-y placeholder:text-base text-sm text-gray-900 focus:border-blue-500 focus:outline-none peer border-gray-300`}
